...
<div class="container mt-5">
    ...
    <form id="form-builder" method="POST" action="{{ route('form-builder.store') }}">
        @csrf
    ...
    <button type="button" id="form-submit-preview" class="btn btn-success mt-3">Submit Form</button>
        ...
        <button type="submit" class="btn btn-primary mt-4">Save Form</button>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   document.querySelectorAll('.add-field').forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        console.log("Clicked field type:", type); // ← Add this
    ...
    // Modal form submission for options
